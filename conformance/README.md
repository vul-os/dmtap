...
`SUITE.md` catalogs **350** numbered cases and `suite.json` mirrors all **350** — the two are **in
...
self-contained CBOR-reject cases whose bytes are inline); 269 are `construction-todo` — each
...
partition is exact: 56 + 6 + 269 + 19 = 350.
