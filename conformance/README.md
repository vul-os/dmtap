...
`SUITE.md` catalogs **343** numbered cases and `suite.json` mirrors all **343** — the two are **in
...
self-contained CBOR-reject cases whose bytes are inline); 263 are `construction-todo` — each
...
partition is exact: 56 + 6 + 263 + 18 = 343.
