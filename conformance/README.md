...
`SUITE.md` catalogs **308** numbered cases and `suite.json` mirrors all **308** — the two are **in
...
self-contained CBOR-reject cases whose bytes are inline); 239 are `construction-todo` — each
...
partition is exact: 46 + 6 + 239 + 17 = 308.
