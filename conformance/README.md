...
and it is what surfaced the `SYNC.md` §14 C-01…C-05 corrections). The five that were previously NOT-FROZEN —
...
§5.2.1 decided the response shape and the MUST NOT first; the vectors followed. This section is listed here only for discoverability; `SYNC.md` §10, not
